...
import { OrderStatus } from '../../../..//libs/shared/src/common/enums/order-status.enum';
import { PaymentStatus } from '../../../..//libs/shared/src/common/enums/payment-status.enum';

@Injectable()
export class PaymentsService {
  private readonly ORDER_URL = process.env.ORDER_SERVICE_URL || 'http://localhost:3003';
